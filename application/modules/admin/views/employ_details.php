...
?>
        <div class="row">
          ...
          <div class="col-lg-2"><?php echo  anchor('admin/editemploy/'.$row->user_id.'', 'Edit');?>&nbsp;|&nbsp;<a href="javascript:void();" onclick="delete_employ(<?php echo "'".$row->user_name."'";?>,<?php echo "'".$row->user_id."'";?>);">Delete</a></div>
